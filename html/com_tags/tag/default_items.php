				...
				<?php else: ?><?php $r = $item->router;?>
                    ...
                    <?php if ($this->params->get('tag_list_show_date', 1)== "publish_up"): ?>
                      <div class="article-date">
                        <span class="icon-time"></span> <span class="narrow"><?php echo JHTML::date($item->displayDate,'l, F jS Y',true) ?></span>
                        <?php echo ContentHelperRoute::getArticleRoute($item->author); ?>
                      </div>
                     <?php endif; ?>
